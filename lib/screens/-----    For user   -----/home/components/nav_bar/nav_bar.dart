...
class BottomNavBaru extends StatefulWidget {
  const BottomNavBaru({super.key});

  @override
  State<BottomNavBaru> createState() => _BottomNavBaru();
}

class _BottomNavBaru extends State<BottomNavBaru> {
  int _currIndex = 0;
